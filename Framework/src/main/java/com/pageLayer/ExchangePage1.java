...
public class ExchangePage1 extends BaseTest {
   ...
   private By clickCustomLimit=By.xpath("//*[@id='sell-tab']/div/div[1]/div[2]/form/div/label");
   private By clickSellButton=By.xpath("//*[@class='w-md btn btn-danger']");
   @FindBy(xpath="//*[@id='topnav-menu-content']/ul/li[2]/a")	
